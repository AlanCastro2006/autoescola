...
<head>
<!-- ---------------------------------------------------------------------------------------------------------------------------------------------------------- -->
    <title>Autoescola Caleffi</title>
    <link rel='stylesheet' id='bootstrap-css'
        href='https://www.autoescolacaleffi.com.br/wp-content/themes/screenr/assets/css/bootstrap.min.css?ver=4.0.0'
...
<body>
    ...
    <header>
        <nav class="navbar navbar-expand-lg fixed-top" id="azul">
            <div class="container-fluid">

                {{-- Logo da Autoescola Caleffi --}}
                <a class="navbar-brand d-flex align-items-center" href="/">
                    <img src="{{ Vite::asset('resources/img/logo/logo-autoescola-caleffi.png') }}" class="img-fluid" alt="Logo Autoescola Caleffi">
                </a>
                ...
                <div class="offcanvas offcanvas-end" tabindex="-1" id="navbarOffcanvasLg" aria-labelledby="navbarOffcanvasLgLabel">
                    ...
                    <div class="offcanvas-body">
                        <ul class="navbar-nav nav-pills d-flex justify-content-end flex-grow-1">
                            ...
                            <li class="nav-item">
                                <a class="nav-link roboto-regular {{ request()->is('/servicos') ? 'active' : ''}}" aria-current="page" href="/servicos">SERVIÇOS</a>
                            </li>

                            <li class="nav-item">
                                <a class="nav-link roboto-regular {{ request()->is('/links') ? 'active' : ''}}" aria-current="page" href="/links">LINKS ÚTEIS</a>
                            </li>
